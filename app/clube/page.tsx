  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        {/* Hero */}
        <section className="bg-linear-to-br from-primary via-primary to-secondary py-16 md:py-24">
          <Container>
            <div className="max-w-3xl mx-auto text-center text-white">
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Formação continuada, recursos práticos e uma comunidade que te
                apoia no dia a dia profissional
              </p>
            </div>
          </Container>
        </section>
              ...
              <Card className="p-8 md:p-12 border-2">
                ...
                <div className="bg-muted/30 rounded-lg p-6 mb-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    Por um valor simbólico mensal, você tem acesso a todo o
                    conteúdo, recursos e suporte da comunidade. Entre em contato
                    para conhecer as opções de assinatura.
                  </p>
                  <p className="text-sm text-muted-foreground italic">
                    * Condições especiais para estudantes e grupos
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  >
                    <Link href="/#planos">Veja os planos disponíveis</Link>
                  </Button>
                </div>
              </Card>
            </div>
        ...
        <svg
          className="w-full text-primary/5 -mt-px"
          viewBox="0 0 1200 120"
          preserveAspectRatio="none"
        >
          <path
          ...
          <Container>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                No Compartilhar Clube, você não está sozinho(a). Aqui,
                profissionais como você se encontram para compartilhar
                experiências, aprender juntos e crescer de forma contínua.
              </p>
              <Button
                asChild
                size="lg"
